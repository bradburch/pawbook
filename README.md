...
> **Status — Phase 0 (extraction).** The booking flow stores requests in D1 (Cloudflare's
...
```bash
npm install
npm run seed:local                                # schema + demo tenants (Brad Paws, Happy Tails)
...
- Widget: `http://localhost:8787/embed/brad-paws`
...
src/shared/     Pure booking/date/pricing logic (vendored; zero runtime deps)
